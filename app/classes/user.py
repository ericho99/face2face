import datetime
class User:
	def __init__(self, username, psw, fname="", lname="", b_month=1, b_day=1, b_year=1, credit_num = "",
				 payment_type = "", prof_pic = ""):
	# consider adding more info/different data types
		self.psw = psw # should be hashed
		self.username = username 
		self.fname = fname
		self.lname = lname
		self.birthday = datetime.date(b_year, b_month, b_day) # default is meaningless
